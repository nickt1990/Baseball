...
Game_Event.prototype.updateSensor = function () {
    ...
    //if (this._eventId == '20') { console.log(this.page()) };
...
// Failed Attempt at initializing the sensor properties with event initialization.
LS.Game_Event_init = Game_Event.prototype.initialize;
Game_Event.prototype.initialize = function (mapId, eventId) {
    LS.Game_Event_init.call(this, mapId, eventId);
}
